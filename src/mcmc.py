...
class UncollapsedGibbsIBP(nn.Module):
    ...
    def resample_Zik(self,X,Z,A,i,k):
        ...
        print("log prior if 0",log_prior_if_0)
        print("log likelihood",log_likelihood_if_0)
        ...
        print("log_prior if 1", log_prior_if_1)
        print("log_likelihood",log_likelihood_if_1)
        log_score_if_1 = log_prior_if_1 + log_likelihood_if_1
        log_scores = torch.cat((log_score_if_0,log_score_if_1),0)
        print("log scores shape",log_scores.size())
